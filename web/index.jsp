    ...
    <ul>
        <li><a>商品管理</a>
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/adminGoods/selectGoods?act=deleteSelect" target="center">删除商品</a></li>
                <li><a href="${pageContext.request.contextPath}/adminGoods/selectGoods?act=updateSelect" target="center">修改商品</a></li>
